...
@ObjectModel: {
  sapObjectNodeType.name: 'ZRAP100_ATRAVGAO'
}
@ObjectModel.semanticKey: ['TravelID'] //case-sensitive
@AccessControl.authorizationCheck: #MANDATORY
define root view entity ZC_RAP100_ATRAVGAO
  provider contract transactional_query
  as projection on ZR_RAP100_ATRAVGAO
  association [1..1] to ZR_RAP100_ATRAVGAO as _BaseEntity on $projection.TravelID = _BaseEntity.TravelID
{
