CLASS zcl_rap100_gen_data_gao DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_gao IMPLEMENTATION.
...
*   clear data
    DELETE FROM zrap100_atravgao .
    DELETE FROM zrap100_atrvgo_d .

    "insert travel demo data
    INSERT zrap100_atravgao  FROM (
        SELECT
